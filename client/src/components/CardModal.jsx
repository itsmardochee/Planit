  ...
  return (
    <>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all${!can('card:update') ? ' bg-gray-50 dark:bg-gray-900 cursor-default' : ''}`}
                    placeholder={t(
                ...
                <div>
                  ...
                  <textarea
                    ...
                    readOnly={!can('card:update')}
                    rows="5"
                    className={`w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none${!can('card:update') ? ' bg-gray-50 dark:bg-gray-900 cursor-default' : ''}`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-700 dark:to-gray-800 rounded-lg p-4 border border-blue-200 dark:border-gray-600">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 outline-none${!can('card:update') ? ' bg-gray-50 dark:bg-gray-900 cursor-default opacity-70' : ''}`}
                    />
                  </div>
                ...
                {/* Member Assignment */}
                {can('card:assign') && members && members.length > 0 && (
      ...
      <ConfirmModal
        ...
        title={t('cards:confirmDeleteTitle', { defaultValue: 'Delete Card' })}
